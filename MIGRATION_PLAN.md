...
- [x] **Phase 5: Components** — ChatPanel, ChatMessage, FolderTree, Editors (Master + Collab), Settings, ExportModal, TemplateChooser, GoalToast
- [x] **Phase 6: Pages** — Main app shell (`/app`), landing page (`/`)
- [x] **Phase 7: Integration & Testing** — Wire everything together, test flows end-to-end
